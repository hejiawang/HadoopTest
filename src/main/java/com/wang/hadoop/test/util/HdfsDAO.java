package com.wang.hadoop.test.util;
...
public final class HdfsDAO  {
	
	//修改成自己的HDFS主机地址
    private static final String HDFS = "hdfs://192.168.32.130:8020/";
    /**
     * 两个构造器
     * @param conf
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        //hdfs.mkdirs("/test1");
        hdfs.createFile("/test1/testContent.txt", "asfdfasdfasdfasdf\nasdfasdf");
